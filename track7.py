...
def draw_roi(frame, roi_points):
    ...
    :param roi_points: List of points defining the ROI polygon
    :return: The frame with ROI drawn
    """
...
def recognize_faces(frame, known_face_embeddings, known_names, roi_points):
    ...
    for face in faces:
        ...
        elif is_face_in_roi(bbox_center, roi_points):
            color = (0, 255, 0)  # Green for recognized faces inside ROI
        else:
            color = (0, 255, 255)  # Yellow for recognized faces outside ROI
